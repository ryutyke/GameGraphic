...
LPCWSTR g_pszWindowName = L"2019102090 류승현 LAB04";
...
HRESULT InitDevice()
{
	...
	// 7. vertex, index, constant buffer 생성
	...
	// Texture Object (texture image) 전달
...
void Render()
{
	...
	if (g_driverType == D3D_DRIVER_TYPE_REFERENCE) {
		...
		if (timeStart == 0)
			timeStart = timeCur;
		t1 = ((timeCur - timeStart) * 2) / 1000.0f;
	}
	g_worldMatrix = XMMatrixRotationY(t1);
